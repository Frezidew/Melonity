...
(function (AutoLotus) {
    ...
    AutoLotus.exampleScript.OnUpdate = function () {
        ...
        var lotus = localHero.GetItem("item_famango", true) ? localHero.GetItem("item_famango", true) : localHero.GetItem("item_great_famango", true) ? localHero.GetItem("item_greater_famango", true) : localHero.GetItem("item_greater_famango", true);
